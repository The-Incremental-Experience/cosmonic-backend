...
#[derive(Clone, Debug, Default, Deserialize, Eq, PartialEq, Serialize)]
pub struct TransformMessageResponse {
...
// Encode TransformMessageResponse as CBOR and append to output stream
#[doc(hidden)]
#[allow(unused_mut)]
pub fn encode_transform_message_response<W: wasmbus_rpc::cbor::Write>(
    mut e: &mut wasmbus_rpc::cbor::Encoder<W>,
    val: &TransformMessageResponse,
) -> RpcResult<()>
where
    <W as wasmbus_rpc::cbor::Write>::Error: std::fmt::Display,
{
...
// Decode TransformMessageResponse from cbor input stream
#[doc(hidden)]
pub fn decode_transform_message_response(
    d: &mut wasmbus_rpc::cbor::Decoder<'_>,
) -> Result<TransformMessageResponse, RpcError> {
    let __result = {
        ...
        let is_array = match d.datatype()? {
            ...
            _ => {
                return Err(RpcError::Deser(
                    "decoding struct TransformMessageResponse, expected array or map".to_string(),
                ))
            }
        };
        if is_array {
        ...
        TransformMessageResponse {
            ...
            success: if let Some(__x) = success {
                ...
                return Err(RpcError::Deser(
                    "missing field TransformMessageResponse.success (#1)".to_string(),
                ));
            },
        }
    };
    ...
    async fn dispatch(&self, ctx: &Context, message: Message<'_>) -> Result<Vec<u8>, RpcError> {
        match message.method {
            "TransformMessage" => {
                ...
                let resp = Chatlog::transform_message(self, ctx, &value).await?;
    ...
    async fn transform_message(
        ...
        let resp = self
            ...
            .send(
                ctx,
                Message {
                    method: "Chatlog.TransformMessage",
        ...
        let value: TransformMessageResponse = wasmbus_rpc::common::deserialize(&resp)
            .map_err(|e| RpcError::Deser(format!("'{}': TransformMessageResponse", e)))?;
        Ok(value)
    }
    #[allow(unused)]
    async fn get_messages(&self, ctx: &Context) -> RpcResult<MessagesList> {
